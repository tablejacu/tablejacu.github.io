document.addEventListener('DOMContentLoaded', function () {
    ...
    // =========================================================================
    // === YOUR SYLLABUS DATA IS HERE ==========================================
    // =========================================================================
    // This data has been extracted from the Nios Table.docx file.
    // To edit, change the text within the quotes "". Use empty quotes for a blank cell.
    // =========================================================================
    ...
    // Function to generate the table from syllabus data
    function generateTable() {
        ...
        syllabusData.forEach(chapter => {
            ...
            row.innerHTML = `
                <td class="ch-no" data-label="CH NO">${chapter.ch_no}</td>
                <td data-label="English">${chapter.english}</td>
                <td data-label="Accountancy">${chapter.accountancy}</td>
                <td data-label="Economics">${chapter.economics}</td>
                <td data-label="Business Studies">${chapter.bus_studies}</td>
                <td data-label="Data Entry">${chapter.data_entry}</td>
            `;
    ...
    themeToggle.addEventListener('click', () => {
        ...
        let theme = document.body.classList.contains('dark-mode') ? 'dark-mode' : 'light';
